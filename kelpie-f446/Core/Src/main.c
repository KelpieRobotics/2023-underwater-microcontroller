...
#define PWMVALUE (int)1800/0.0381
#define TO_PWM(pwm) (int)pwm/0.0381
#define STARTUP_PWM 39402
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_14|LIGHT_MODULE_EN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : LEAK_EXTI_Pin */
  GPIO_InitStruct.Pin = LEAK_EXTI_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(LEAK_EXTI_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : PB14 LIGHT_MODULE_EN_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_14|LIGHT_MODULE_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
