...
#ifndef PB_KR23_PICOMSDATATYPES_KR23_PB_H_INCLUDED
#define PB_KR23_PICOMSDATATYPES_KR23_PB_H_INCLUDED
#include <pb.h>
...
#define KR23_ThrusterCommand_init_default        {false, 0, false, 0, false, 0, false, 0, false, 0, false, 0, false, 0, false, 0, _KR23_KelpieResult_MIN}
#define KR23_AttachmentCommand_init_default      {false, 0, false, 0, false, 0, false, 0, false, _KR23_KelpieClawState_MIN, _KR23_KelpieResult_MIN}
...
#define KR23_ThrusterCommand_init_zero           {false, 0, false, 0, false, 0, false, 0, false, 0, false, 0, false, 0, false, 0, _KR23_KelpieResult_MIN}
#define KR23_AttachmentCommand_init_zero         {false, 0, false, 0, false, 0, false, 0, false, _KR23_KelpieClawState_MIN, _KR23_KelpieResult_MIN}
...
X(a, STATIC,   OPTIONAL, UINT32,   thruster_0_PWM,    1) \
X(a, STATIC,   OPTIONAL, UINT32,   thruster_1_PWM,    2) \
X(a, STATIC,   OPTIONAL, UINT32,   thruster_2_PWM,    3) \
X(a, STATIC,   OPTIONAL, UINT32,   thruster_3_PWM,    4) \
X(a, STATIC,   OPTIONAL, UINT32,   thruster_4_PWM,    5) \
X(a, STATIC,   OPTIONAL, UINT32,   thruster_5_PWM,    6) \
X(a, STATIC,   OPTIONAL, UINT32,   thruster_6_PWM,    7) \
X(a, STATIC,   OPTIONAL, UINT32,   thruster_7_PWM,    8) \
X(a, STATIC,   REQUIRED, UENUM,    result,           14)
...
X(a, STATIC,   OPTIONAL, UINT32,   servo_0_PWM,       1) \
X(a, STATIC,   OPTIONAL, UINT32,   servo_1_PWM,       2) \
X(a, STATIC,   OPTIONAL, UINT32,   servo_2_PWM,       3) \
X(a, STATIC,   OPTIONAL, UINT32,   light_PWM,         4) \
X(a, STATIC,   OPTIONAL, UENUM,    claw_state,        5) \
X(a, STATIC,   REQUIRED, UENUM,    result,           14)
...
X(a, STATIC,   REQUIRED, DOUBLE,   depth,             4) \
X(a, STATIC,   REQUIRED, DOUBLE,   accelerometer_x,   5) \
X(a, STATIC,   REQUIRED, DOUBLE,   accelerometer_y,   6) \
X(a, STATIC,   REQUIRED, DOUBLE,   accelerometer_z,   7) \
X(a, STATIC,   REQUIRED, DOUBLE,   quaternion_real,   8) \
X(a, STATIC,   REQUIRED, DOUBLE,   quaternion_i,      9) \
X(a, STATIC,   REQUIRED, DOUBLE,   quaternion_j,     10) \
X(a, STATIC,   REQUIRED, DOUBLE,   quaternion_k,     11) \
X(a, STATIC,   REQUIRED, UENUM,    result,           14)
#define KR23_SensorsData_CALLBACK NULL
#define KR23_SensorsData_DEFAULT NULL

#define KR23_SafetyData_FIELDLIST(X, a) \
X(a, STATIC,   REQUIRED, DOUBLE,   power_0,           1) \
X(a, STATIC,   REQUIRED, DOUBLE,   power_1,           2) \
X(a, STATIC,   REQUIRED, DOUBLE,   power_2,           3) \
X(a, STATIC,   REQUIRED, DOUBLE,   power_3,           4) \
X(a, STATIC,   REQUIRED, DOUBLE,   current_0,         5) \
X(a, STATIC,   REQUIRED, DOUBLE,   current_1,         6) \
X(a, STATIC,   REQUIRED, DOUBLE,   current_2,         7) \
X(a, STATIC,   REQUIRED, DOUBLE,   current_3,         8) \
X(a, STATIC,   REQUIRED, DOUBLE,   voltage_0,         9) \
X(a, STATIC,   REQUIRED, DOUBLE,   voltage_1,        10) \
X(a, STATIC,   REQUIRED, DOUBLE,   voltage_2,        11) \
X(a, STATIC,   REQUIRED, DOUBLE,   voltage_3,        12) \
X(a, STATIC,   REQUIRED, BOOL,     leak,             13) \
X(a, STATIC,   REQUIRED, UENUM,    result,           14)
#define KR23_SafetyData_CALLBACK NULL
#define KR23_SafetyData_DEFAULT NULL

#define KR23_PollMessage_FIELDLIST(X, a) \
X(a, STATIC,   REQUIRED, UINT32,   thruster_0_PWM,    1) \
X(a, STATIC,   REQUIRED, UINT32,   thruster_1_PWM,    2) \
X(a, STATIC,   REQUIRED, UINT32,   thruster_2_PWM,    3) \
X(a, STATIC,   REQUIRED, UINT32,   thruster_3_PWM,    4) \
X(a, STATIC,   REQUIRED, UINT32,   thruster_4_PWM,    5) \
X(a, STATIC,   REQUIRED, UINT32,   thruster_5_PWM,    6) \
X(a, STATIC,   REQUIRED, UINT32,   thruster_6_PWM,    7) \
X(a, STATIC,   REQUIRED, UINT32,   thruster_7_PWM,    8) \
X(a, STATIC,   REQUIRED, UINT32,   servo_0_PWM,       9) \
X(a, STATIC,   REQUIRED, UINT32,   servo_1_PWM,      10) \
X(a, STATIC,   REQUIRED, UINT32,   servo_2_PWM,      11) \
X(a, STATIC,   REQUIRED, UINT32,   light_PWM,        12) \
X(a, STATIC,   REQUIRED, UINT32,   claw_state,       13) \
X(a, STATIC,   REQUIRED, UENUM,    result,           14)
